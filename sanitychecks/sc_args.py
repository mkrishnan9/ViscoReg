...
def add_args(parser):
    ...
    parser.add_argument('--pretrain_model_path', type=str, default='',
                        help='path to a pretrained model checkpoint to warm-start from '
                             '(e.g. output of train_pretrain_1d.py); empty string = train from scratch')
    ...
    parser.add_argument('--nonmnfld_range', type=float, default=None,
                        help='half-range for non-manifold grid sampling; None = auto (1.5x endpoints)')
