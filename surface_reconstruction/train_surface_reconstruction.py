...
Net.to(device)
criterion = Loss(weights=args.loss_weights, loss_type=args.loss_type, div_decay=args.div_decay, div_type=args.div_type, adaptive_epsilon_params = args.adap_eps_params)
...
for batch_idx, data in enumerate(train_dataloader):
    ...
    # current_eikonal_for_ema = loss_dict['eikonal_term']
    # criterion.update_epsilon_schedule(batch_idx, args.n_iterations, current_pure_eikonal_residual_batch=current_eikonal_for_ema)
    scheduler.step()
